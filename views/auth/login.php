 ...
 flex justify-center items-center h-[100vh] w-full font-[ 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif] ">
    <div class=" rounded-[15px] h-auto w-[30%] bg-[#fccfa2ff] flex flex-col text-center p-10 gap-5">
        <div class=" w-full flex flex-col self-start">
            <h1 class="p-10 bg-[rgba(116,16,15,1)] text-white rounded-[15px] "><i class="fas fa-user-circle"></i>Connexion</h1>

        </div>

        <form action="" method="POST" class=" h-auto w-full mb-[10px]" name="login">
            <div class="">
                <label for="name" class=" h-auto w-full mb-[10px]"> <i class="fas fa-user icon"></i> Nom d'utilisateur</label>
            ...
            <button type="submit" class="h-[40px] w-[200px] rounded-[100px]  bg-orange-300 mt-[10px]">
                <i class="fas fa-sign-in-alt"></i> Se connecter
            </button>
        </form>

        <div class="">
            <p>Pas encore de compte ? <a href="signeup" class="text-[#460cf5ff]">Créer un compte</a></p>
